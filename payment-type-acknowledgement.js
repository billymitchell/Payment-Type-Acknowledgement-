...
window.addEventListener("load", () => {
  payment_continue_btn.setAttribute("disabled", true); // Disable the "Continue" button initially
  showAcknowledgmentForSelectedOption(); // Show acknowledgment for the selected payment option on load
});
